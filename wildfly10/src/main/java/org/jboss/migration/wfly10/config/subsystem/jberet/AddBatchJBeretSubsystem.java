 ...
 */
package org.jboss.migration.wfly10.config.subsystem.jberet;
...
public class AddBatchJBeretSubsystem extends AddSubsystem {
    ...
    protected void addSubsystem(WildFly10Subsystem subsystem, WildFly10SubsystemManagement subsystemManagement, ServerMigrationTaskContext context) throws Exception {
        ...
        subsystemManagement.getConfigurationManagement().executeManagementOperation(compositeOperationBuilder.build().getOperation());
    }
}
