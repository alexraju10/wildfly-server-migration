 ...
 * @author emmartins
 */
public interface WildFly10SubsystemManagement {
    ModelNode getSubsystem(String name) throws IOException;
    Set<String> getSubsystems() throws IOException;
    void removeSubsystem(String subsystem) throws IOException;
    PathAddress getSubsystemPathAddress(String subsystem);
